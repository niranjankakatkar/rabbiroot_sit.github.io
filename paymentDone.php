...
$oid = $_SESSION['OID'];
$sql="update order_master set status='done' where order_id='$oid'";
echo ''.$sql;
if($conn->query($sql))
{}
                    ...
                    <div class="container mt-5 mb-5">
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-lg-5 text-center p-4"
                                ...
                                <div style="font-size: 50px; color: #4CAF50; margin-bottom: 20px;">✔️</div>
                                <h3 class="fw-bold">Your payment has been received</h3>
                                <p>Thank you for your payment. <br>
                                    Please check your email for a payment confirmation & invoice.</p>
                                <a href="index.php" class="btn mt-2"
                                    style="background: linear-gradient(to right, #6a11cb, #ff6f61); color: white; border: none; padding: 12px 20px; border-radius: 8px; font-size: 16px; transition: 0.3s; text-decoration: none;">
